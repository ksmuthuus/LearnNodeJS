...
router.post('/', async (req, res) => {
    ...
    if (!customer) returnError(res, 404, 'NotFoundException', 'Customer Not Found')
    ...
    //Check Stock
    if (movie.numberInStock === 0) returnError(res, 400, 'OutOfStockException', 'Movie Not Avialable')
    ...
    res.status(201).send(addedRental)
})
